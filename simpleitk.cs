...
namespace esapi
{
    public static class simpleitk
    {
        ...
        public static void save_itkimage(itk.simple.Image itkImage, string path)
        {
            string fn = $"save_itkimage(itkImage, path={path})";
            ...
            itk.simple.ImageFileWriter writer = new ImageFileWriter();
            writer.Execute(itkImage, path, true);
            helper.print($"Image created and saved successfully. path={path}. fn={fn}");
        }
